  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl">
        ...
        {/* Pricing Cards - Disabled until billing is enabled in Clerk */}
        {/* <PricingTable
          checkoutProps={{
            appearance: {
              elements: {
        ...
        <div className="text-center py-8">
          <p className="text-sm text-gray-600 mb-4">Pricing plans will appear once billing is enabled in Clerk dashboard</p>
        </div>
        {/* Footer */}
